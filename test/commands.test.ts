...
beforeAll(async () => {
  ...
  pool = await ensureTestPool("E01-S04", "moneo_e01_commands", ["ai_dispatch_permits", "ai_exclusions", "ai_policies", "command_operations", "accounts", "workspace_members", "workspaces", "users", "app_sessions"]);
