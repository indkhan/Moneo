...
describe("e01-s03 tenant ownership", () => {
  ...
  it("migrations 039 down to 002 roll back and re-apply on the suite database", async () => {
      ...
      expect((back.rows[0] as { n: number }).n).toBe(67);
