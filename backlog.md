...
- Add conservative recurring-payment detection with reviewable evidence before showing commitments.
- Define and test a traceable, per-currency safe-to-spend formula before displaying a value.
- Add AI consent, privacy, loading, empty, and error flows before displaying generated dashboard insights.
- Add notifications, working settings, investment holdings/prices, and dashboard pinning as separate product slices.
