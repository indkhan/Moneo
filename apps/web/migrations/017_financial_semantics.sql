...
ALTER TABLE transactions
  ...
  ADD CONSTRAINT transactions_linked_account_fk FOREIGN KEY (workspace_id, linked_account_id) REFERENCES accounts (workspace_id, id) ON DELETE RESTRICT;
...
ALTER TABLE manual_transactions
  ...
  ADD COLUMN IF NOT EXISTS linked_account_id UUID NULL,
  ADD CONSTRAINT manual_transactions_linked_account_fk FOREIGN KEY (workspace_id, linked_account_id) REFERENCES accounts (workspace_id, id) ON DELETE RESTRICT;
