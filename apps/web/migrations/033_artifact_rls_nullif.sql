-- E05 adversarial fix: 026/028/029 RLS policies used
-- current_setting('app.current_workspace', true)::uuid directly, so an empty
-- or unset context raises invalid_text_representation (22P02) instead of
-- failing closed to zero rows. Every other tenant table uses the NULLIF
-- guard (see 002_tenancy.sql). Recreate the eight artifact policies with it.
-- No table, column, or data change; policy names are unchanged
-- (workspace_isolation on each table).
