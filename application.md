...
- Dashboard net worth uses source balance history per currency without conversion, spending uses booked categorised outflow, and accounts/transactions remain traceable to imported CSV data. Unsupported budgets, recurring detection, safe-to-spend, AI, notifications, and settings are explicitly labelled unavailable.
